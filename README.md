...
background, and save the final output image. The components are contained inside a 3D-printed enclosure that is specially designed to properly mount a Raspberry Pi, a 7 inch touchscreen and a USB camera.
